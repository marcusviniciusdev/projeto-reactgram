...
const Profile = () => {
  ...
  //captando a foto do input e colocando no state
  const handleFile = (e) => {
  ...
  //abrindo formulário de edição de foto
  ...
  return (
    <div id="profile">
      ...
      {/* verificando se o usuario do perfil acessado é o mesmo usuário logado para poder publicar fotos */}
      {id === userAuth._id && (
        <>
          {/* FORMULÁRUIO DE CRIAÇÃO */}
